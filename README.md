...
## 安装链接 
  ...
  * Surge:
    ...
    * 空气质量地图(可用，可行性验证，未修正图层和坐标):[Apple_Weather_Map.beta.sgmodule](https://github.com/VirgilClyne/iRingo/blob/beta/sgmodule/Apple_Weather_Map.beta.sgmodule?raw=true " Replace Apple Weather Map with 🇺🇸US @waqi.info")
    * 空气质量地图(施工中，不可用，修正坐标和图层):[Apple_Weather_Map.alpha.sgmodule](https://github.com/VirgilClyne/iRingo/blob/beta/sgmodule/Apple_Weather_Map.alpha.sgmodule?raw=true " Replace Apple Weather Map with 🇺🇸US @waqi.info")
